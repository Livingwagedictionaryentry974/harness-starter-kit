...
Harness Doctor は、リポジトリが AI coding agent と安定して協働できる状態かを
評価します。Agent Instructions、Feedback Loops、Durable Memory、Structural
Safety、Adoption Clarity に基づいて Harness Score を報告します。
